...
function empiezaConNueve(n) {
  ...
  var primerCaracter = nAString.charAt(0)
  if (primerCaracter == 9){
    return true
  } else {
  return false
...
function mesesDelAño(array) {
  ...
  //el array buscando los meses de "Enero", "Marzo" y "Noviembre", guardarlo 
  //en nuevo array y retornarlo. Si alguno de los meses no está, 
  // devolver: "No se encontraron los meses pedidos" Tu código:
  mesesPedidos = [];
  for(i = 0; i < array.length; i++){
